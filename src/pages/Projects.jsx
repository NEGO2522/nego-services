              ...
              <div className="flex flex-col gap-6">
                ...
                <div className="flex items-center gap-3">
                  <div
                    ...
                    style={{ background: 'rgba(0,0,0,0.06)', filter: 'grayscale(1)' }}
                  >
                    {p.emoji}
                  </div>
                  <h2
                ...
                {/* Description */}
                <p className="text-[14px] sm:text-[15px] text-black/50 leading-[1.8] max-w-2xl">
                  {p.desc}
                </p>

                {/* Highlights */}
                <ul className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-2 max-w-2xl">
                  {p.highlights.map((h) => (
